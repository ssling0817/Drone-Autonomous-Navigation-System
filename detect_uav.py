...
#00
   ...
   # msg = msg.encode(encoding="utf-8") 
    #sent = sock.sendto("up 80".encode(encoding="utf-8"), tello_address)
    #print('up 80')	
    #time.sleep(1)
                ...
                for x1, y1, x2, y2, conf, cls_pred in detections:
                    ...
                    if(classes[int(cls_pred)]==target):
                        ...
                        if(box_w>960*0.2 or box_h>720*0.2):
                            ran=60
                        if((x_center<width/2+ran)and(x_center>width/2-ran)and(y_center>height/2-ran)and(y_center<height/2+ran)):
